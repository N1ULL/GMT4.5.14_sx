...
grdimage new2.grd -R -JM16 -Ba5f1g5/a5f1g5:."中国大陆P波速度分布图":neWS -Inew2.grd.int -CNew_gray.cpt -Xc -Yc -K>plot1.ps
...
psscale -CZ_vp0.cpt -D8/-1/16/0.2h -B0.2:"P波速度":/0.2:"Km/s": -O>>plot1.ps
